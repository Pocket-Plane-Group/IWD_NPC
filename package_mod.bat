...
set "mod_name=Icewind Dale NPCs MOD for Icewind Dale"
set mod_version=v9
set mod_folder=iwdnpc

REM /* MODIFY: list here which IE games the mod is compatible with, from this list of possibilities: */
REM /* %bg1%, %bg2%, %bgt%, %tutu%, %bgee%, %bgiiee%, %iwd1%, %iwdee%, %iwd2%, %iwd2ee%, %iwd-in-bg2%, %pst%, %pstee% */
set "compatible_games=%iwd1%, %iwdee%, %iwd-in-bg2%"
...
set iconv_folder=%mod_folder%\Language\iconv
set mod_readme=https://raw.githubusercontent.com/Pocket-Plane-Group/IWD_NPC/main/iwdnpc/Readme-IWDNPC.txt
